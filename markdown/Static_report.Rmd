...
Containing data extracted 21 December 2020
...
```{r cohortoverview,  out.width = "100%", fig.align="center", fig.cap = "Overview of cohort and outcomes as of 21 December 2020."}
...
```{r labs1, echo=FALSE, out.width= "50%", message=FALSE, fig.height=5, fig.ncol = 2, fig.subcap=c("Respiratory rate", "Heart rate", "Temperature", "Systolic blood pressure", "Oxygen saturation in room air."), fig.cap = "Box and whisker plots for observations at hospital presentation stratified by age group. Outliers are omitted. N is the number of individuals included in the plot (this varies between plots due to data completeness)."}
...
```{r labs2, echo=FALSE, out.width= "50%", message=FALSE, fig.height=3, fig.ncol = 2,  fig.subcap=c("Alanine transaminase (ALT)", "Activated partial thromboplastin time (APTT)", "Aspartate transaminase (AST)", "Bilirubin",  "C-reactive protein (CRP)", "Lymphocytes", "Neutrophils", "Protrombin time", "Urea", "White blood cell count (WCC)"), fig.cap = "Box and whisker plots for laboratory results within 24 hours of hospital presentation stratified by age group. Outliers are omitted. N is the number of individuals included in the plot (this varies between plots due to data completeness)."}
