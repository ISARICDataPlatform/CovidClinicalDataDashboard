...
Containing data extracted `r format(ref.date, "%d %B %Y")`
...
**Figure 1**: Overview of cohort and outcomes as of `r format(ref.date, "%d %B %Y")`.


```{r cohortoverview,  out.width = "100%", fig.align="center", fig.cap=glue("Overview of cohort and outcomes as of {format(ref.date, '%d %B %Y')}")}
...
```{r agepyramid, echo = FALSE, fig.align="center", fig.cap=glue("Age and sex distribution of patients. Bar fills are outcome (death/discharge/lost to follow-up/ongoing care) at the time of report.")}
...
```{r table2, tab.cap = "Table 2: Outcome by age and sex. Proportions are calculated using the column total as the denominator."}
