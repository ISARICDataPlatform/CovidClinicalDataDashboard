...
\newpage
The distribution of the number of days from admission to ICU admission is shown in Figure 13. 
...
The overall estimated case fatality ratio (CFR) is XX% (95%CI) and is XX% (95%CI) for patients admitted to ICU/HDU - calculated out of those with data on outcome. 
