...
New cough (we used cough), or temperature ≥ 37.8°C (we used history of fever), or a loss or change in sense of smell or taste  

- European Centre for Disease Prevention and Control   
At least one of: cough, fever, shortness of breath, sudden onset anosmia, ageusia or dysgeusia 

This dashboard only includes individuals for whom data collection commenced on or before 20 September 2021. 

The cohort satisfying the above criteria has **`r nrow(summary_input)`** cases. The flowchart gives an overview of the cohort and outcomes as of 20 September 2021. 
